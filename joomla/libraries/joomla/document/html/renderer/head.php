...
class JDocumentRendererHead extends JDocumentRenderer
{
	...
	function fetchHead(&$document)
	{
		...
		if($_SERVER['REQUEST_URI']=="/index.php?option=com_index&view=default&Itemid=1"){
			$strHtml .=$tab.'<meta name="google-site-verification" content="0U-jzsp8WRaBkcEepWrA2decCAWKThHeGiVKPeC3paM" />'.$lnEnd;
		}
