...
class JSimpleXMLElement extends JObject
{
	...
	function toString($whitespace=true)
	{
		...
		$temp_array=array('sitemap.html','/contact-us/','#','/index.php?option=com_content&view=category&id=27&Itemid=18','/about-us/','mailto:service@leadtochina.com');
		foreach($this->_attributes as $attr => $value) {
			if(in_array($value,$temp_array)){
				$out .= ' '.$attr.'="'.htmlspecialchars($value).'" rel="nofollow"';
			}else{
