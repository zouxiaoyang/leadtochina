...
class JPagination extends JObject
{
	...
	function __construct($total, $limitstart, $limit)
	{
		...
		$p_option = JRequest::getVar('option');
		if($p_option=="com_feedback" OR $p_option=="com_clienttravel"){
		$displayedPages	= 1000;
		}else{
		$displayedPages=10;
		}
	...
	function _buildDataObject()
	{
		...
		//var_dump($data->all);
//object(JPaginationObject)#234 (4) { ["text"]=> string(8) "View All" ["base"]=> NULL ["link"]=> NULL ["_errors"]=> array(0) { } } ;
		if (!$this->_viewall) {
			//echo "test";
			//exit;
			$data->all->base	= '0';
...
//exit;
		...
		//echo $data->all->link;
		//exit;
	//if(trim($data->all->link)=="/index.php?feedback/=&Itemid=82"){

		//echo "test";
		//exit;
		if($uri->_vars['option']=="com_feedback"){
		
		
		$data->all->link="/index.php?option=com_feedback&Itemid=82";
		$data->start->link="/index.php?option=com_feedback&Itemid=82";
		$data->pages[1]->link="/index.php?option=com_feedback&Itemid=82";
		}
	//}
//object(stdClass)#235 (6) { ["all"]=> object(JPaginationObject)#234 (4) { ["text"]=> string(8) "View All" ["base"]=> string(1) "0" ["link"]=> string(35) "/index.php?feedback/=&Itemid=82" ["_errors"]=> array(0) { } } ["start"]=> object(JPaginationObject)#233 (4) { ["text"]=> string(5) "Start" ["base"]=> NULL ["link"]=> NULL ["_errors"]=> array(0) { } } ["previous"]=> object(JPaginationObject)#232 (4) { ["text"]=> string(4) "Prev" ["base"]=> NULL ["link"]=> NULL ["_errors"]=> array(0) { } } ["next"]=> object(JPaginationObject)#231 (4) { ["text"]=> string(4) "Next" ["base"]=> float(20) ["link"]=> string(62) "/index.php?option=com_feedback&Itemid=82&limitstart=20" ["_errors"]=> array(0) { } } ["end"]=> object(JPaginationObject)#230 (4) { ["text"]=> string(3) "End" ["base"]=> float(420) ["link"]=> string(63) "/index.php?option=com_feedback&Itemid=82&limitstart=420" ["_errors"]=> array(0) { } } ["pages"]=> array(10) { [1]=> object(JPaginationObject)#229 (4) { ["text"]=> float(1) ["base"]=> NULL ["link"]=> NULL ["_errors"]=> array(0) { } } [2]=> object(JPaginationObject)#226 (4) { ["text"]=> float(2) ["base"]=> float(20) ["link"]=> string(62) "/index.php?option=com_feedback&Itemid=82&limitstart=20" ["_errors"]=> array(0) { } } [3]=> object(JPaginationObject)#227 (4) { ["text"]=> float(3) ["base"]=> float(40) ["link"]=> string(62) "/index.php?option=com_feedback&Itemid=82&limitstart=40" ["_errors"]=> array(0) { } } [4]=> object(JPaginationObject)#236 (4) { ["text"]=> float(4) ["base"]=> float(60) ["link"]=> string(62) "/index.php?option=com_feedback&Itemid=82&limitstart=60" ["_errors"]=> array(0) { } } [5]=> object(JPaginationObject)#237 (4) { ["text"]=> float(5) ["base"]=> float(80) ["link"]=> string(62) "/index.php?option=com_feedback&Itemid=82&limitstart=80" ["_errors"]=> array(0) { } } [6]=> object(JPaginationObject)#238 (4) { ["text"]=> float(6) ["base"]=> float(100) ["link"]=> string(63) "/index.php?option=com_feedback&Itemid=82&limitstart=100" ["_errors"]=> array(0) { } } [7]=> object(JPaginationObject)#239 (4) { ["text"]=> float(7) ["base"]=> float(120) ["link"]=> string(63) "/index.php?option=com_feedback&Itemid=82&limitstart=120" ["_errors"]=> array(0) { } } [8]=> object(JPaginationObject)#240 (4) { ["text"]=> float(8) ["base"]=> float(140) ["link"]=> string(63) "/index.php?option=com_feedback&Itemid=82&limitstart=140" ["_errors"]=> array(0) { } } [9]=> object(JPaginationObject)#241 (4) { ["text"]=> float(9) ["base"]=> float(160) ["link"]=> string(63) "/index.php?option=com_feedback&Itemid=82&limitstart=160" ["_errors"]=> array(0) { } } [10]=> object(JPaginationObject)#242 (4) { ["text"]=> float(10) ["base"]=> float(180) ["link"]=> string(63) "/index.php?option=com_feedback&Itemid=82&limitstart=180" ["_errors"]=> array(0) { } } } } 
