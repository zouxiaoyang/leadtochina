<?php
	...
	if($user->get('usertype')=='销售'){
		header("Location:/administrator/index.php?option=com_magrequestion");
		exit;
	}	
/**
					...
					<div class="m" >
						...
						<tr>
							<td width="55%" valign="top">
								<jdoc:include type="modules" name="icon" /><!--administrator\modules\mod_quickicon\mod_quickicon.php-->
							</td>
