					...
					<table class="adminlist" cellspacing="1" align="center">
						<tbody>
							...
							<tr class="<?php echo "row$k"; ?>">
								<td>
									<?php
									if(!$row->published) echo JHTML::_('tooltip', JText::_('LIST_PUBLISH'), '', '../../../components/com_acymailing/images/warning.png').' ';
									echo acymailing::tooltip($row->description,$row->name,'',$row->name);
