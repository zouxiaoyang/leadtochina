		...
		<div class="col width-60">
			<fieldset class="adminform">
				<legend><?php echo JText::_( 'Details' ); ?></legend>
					...
					<?php if($row->section=="com_cntours" OR $row->section=="com_scenery" OR $row->section=="com_ctours") :?>
...
<?php
if($row->section=="com_cntours" OR $row->section=="com_scenery" OR $row->section=="com_ctours") { echo "<script language=\"javascript\" type=\"text/javascript\"> window.onload=SetDisplay;</script>";  }?>
