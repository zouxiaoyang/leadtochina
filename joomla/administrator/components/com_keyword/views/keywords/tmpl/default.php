...
<?php
	JToolBarHelper::title(  JText::_( '关键字管理' ) );
...
<form action="index.php?option=com_keyword" method="post" name="adminForm">
<table>
	<tr>
...
<div id="tablecell">
	...
	?>
		<tr class="<?php echo "row$k"; ?>">
			...
			<?php if (  JTable::isCheckedOut($this->user->get ('id'), $row->checked_out )  ) {
				...
				?>
				<span class="editlinktip hasTip" title="<?php echo JText::_( 'Edit Pronvince' );?>::<?php echo htmlspecialchars($row->keyword); ?>">
				
					<?php echo htmlspecialchars($row->keyword); ?></span>
				<?php
			}
			?>
			</td>
	...
	<input type="hidden" name="option" value="com_keyword" />
