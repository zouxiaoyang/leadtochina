				...
				<fieldset>
					...
					<table width="100%">
						...
						<tr>
							...
							<td>
								<input class="inputbox" type="text" name="seo_title" size="50" maxlength="255" value="<?php echo $this->item->seo_title; ?>"/>
							</td>
						</tr>
						<tr>
							<td class="key" align="right">
							...
							<td>
								<input class="inputbox" type="text" name="seo_key" size="50" maxlength="255" value="<?php echo $this->item->seo_key; ?>"/>
							</td>
						</tr>
						<tr>
							<td class="key" align="right">
							...
							<td>
								<input class="inputbox" type="text" name="seo_description" size="50" maxlength="255" value="<?php echo $this->item->seo_description; ?>"/>
							</td>
						</tr>
						...
						<tr>
							...
							echo $editor->display( 'menus_des',  $this->item->menus_des, '200', '100', '40', '20', array('pagebreak', 'readmore') ) ;
							?>

<!--textarea rows="3" cols="50" class="inputbox"  name="menus_des" id="menus_des" /><?php echo $this->item->menus_des; ?></textarea-->
							</td>
						</tr>
