 ...
 * @since 1.0
 */
class CtoursViewUploadpic extends JView
{
...
*/if(empty($id)){
		...
		for($i=1;$i<=$pic_count;$i++){
			...
			<br /><a href=\"#\" onclick=\"javascript:del('../index.php?option=com_delpic&id={$piclist[$temp_index]->id}')\">删除</a> <a href=\"index.php?option=com_ctours&c=upload&task=editpic&cid[]=$uid&id={$piclist[$temp_index]->id}\">编辑</a></td>";
