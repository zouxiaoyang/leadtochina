...
//var inpput_pricein="<textarea id=\"price_include[]\" name=\"price_include[]\" cols=20 rows=10>"+price_in+"</textarea>";
...
//row.insertCell(5).innerHTML=inpput_pricein;
...
<?php
	...
	//var priceinVal =document.getElementById('price_in').options[document.getElementById('price_in').selectedIndex].value;
    // var price_in = document.getElementById("price_in").value; 
...
//var inpput_hotel="<input type=\"text\" id=\"price_include[]\" name=\"price_include[]\" value='"+priceinVal+"' size=20>";
...
row.insertCell(2).innerHTML=inpput_three;
row.insertCell(3).innerHTML=inpput_six;
//row.insertCell(4).innerHTML=inpput_hotel;
//row.insertCell(4).innerHTML=inpput_pricein;
...
if($this->row[$i]->off_season==1){

$this->row[$i]->off_season="淡季";

}else{

$this->row[$i]->off_season="旺季";
}


/*
if($this->row[0]->single==1){

$this->row[0]->single="标准间";

}else{

$this->row[0]->single="双人间";
}*/
?>
			<input type="text" name="off_season[<?php echo $priceid;?>]" id="off_season[<?php echo $priceid;?>]" value="<?php echo $this->row[$i]->off_season;?>" size=30>
			</td>
			<td>
			...
			<!--td>
			<input type="text" name="single[<?php echo $priceid;?>]" id="single[<?php echo $priceid;?>]" value="<?php echo $this->row[0]->single;?>" size=30>
			</td-->
			<td>
			<!--a href='javascript:void(0);' onclick="this.parentNode.parentNode.parentNode.deleteRow(this.parentNode.parentNode.rowIndex);">删除</a-->
			</td>
	...
	</table><table ><tr><td height=10>  </td></tr><tr><td><?php 	echo $editor->display( 'price_in',  htmlspecialchars($this->price_in,ENT_QUOTES), '600', '300', '60', '20', array('pagebreak', 'readmore'));?></td></tr></table>
	</fieldset>
</div>
<div class="clr"></div>
