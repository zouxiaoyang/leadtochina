 ...
 * @subpackage	Config
 */
class SceneryController extends JController
{
	/**
	 * Custom Constructor
	 */
	...
	function display( )
	{
		switch($this->getTask())
		{
			...
			case 'edit'    :
			{
				...
				JRequest::setVar( 'view', 'scenery'  );//文件路径设置。是view
...
//["textfieldcheck"]=> string(0) "" ["c293f03092a989911df312e31cbf88f2"]=> string(1) "1" } 
	...
	function remove()
	{
		...
		$this->setRedirect( 'index.php?option=com_scenery', $msg );
	}
