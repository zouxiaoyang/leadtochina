...
<?php
	JToolBarHelper::title(  JText::_( '酒店订单管理' ) );
...
<form action="index.php?option=com_toursOder" method="post" name="adminForm">
	...
	?>
		<tr class="<?php echo "row$k"; ?>">
			...
			<td>
			<a href="index.php?option=com_hotelorder&view=hotelorder&task=showOder&orderid=<?php echo $row->id?>">
			<?php echo $row->hotelname;?></a>
			</td>
			<td align="center">
			...
			<td align="center">
				<!--入住时间：<?php echo $row->checkin;;?>；退出时间：<?php echo $row->checkout;?>-->
