...
<?php
	JToolBarHelper::title(  JText::_( '游轮航期管理' ) );
...
<div id="tablecell">
	...
	for ($i=0, $n=count( $this->items ); $i < $n; $i++)
	{
		...
		$row = &$this->items[$i];
		$ds=$i+1;
		$link1     = JRoute::_( 'index.php?option=com_cruise&view=cntoursact&c=cruiseact&cruiseid='.$this->cid.'&task=edit&cid[]='. $row->id );
