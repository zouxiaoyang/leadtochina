...
<?php
	...
	JToolBarHelper::title(  JText::_( '油轮图片管理' ).': <small><small>[ ' . $text.' ]</small></small>' );
	...
	<table class="admintable">
		...
		<tr>
			...
			<td>
				...
				<textarea name="pic_alt" id="pic_alt" cols="30" rows="5" ><?php echo $this->options[0]->pic_alt;?></textarea>
			</td>
		</tr>
		<tr>
			<td class="key">
...
<div class="clr"></div>
	...
	<input type="hidden" name="cruiseid" value="<?php echo $this->hotelid; ?>" />
