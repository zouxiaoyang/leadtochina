...
<?php
	...
	JToolBarHelper::title(   JText::_( 'Cruise 航期' ).': <small><small>[编辑]</small></small>' );
	JToolBarHelper::save();
	if (!$edit)  {
	...
	<fieldset class="adminform">
		...
		<tr>
           ...
           <tr>
			...
			<td>	<input class="text_area" type="text" name="cruise_date" id="cruise_date" style="width:70px" onfocus="HS_setDate(this)" maxlength="250" value="<?php echo $this->cruise->cruise_date ;?>"  />
	      ...
	      <!--tr>
			...
			<td>	<input class="text_area" type="text" name="month" id="month" size="32" maxlength="250" value="<?php echo $this->cruise->month ;?>"  />
...
<div class="clr"></div>
    ...
    <input type="hidden" name="c" value="cruiseact" />
