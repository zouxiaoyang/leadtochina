 ...
 * @subpackage	Menus
 */
class TagsModelTags extends JModel
{
  var $_data = null;
  ...
  var $_pagination = null;
	...
	function _buildQuery()
	{
		...
		$query = "SELECT * FROM #__cos_tours_package_tag $where $orderby";
		return $query;
	}
	
	function __buildTotalQuery()
	{
	    $where		= $this->_buildContentWhere();
		$orderby = '';
		$query = "SELECT count(*) FROM #__cos_tours_package_tag $where $orderby";
		return $query;
	}
