...
//var inpput_hotel="<input type=\"text\" id=\"single[]\" name=\"single[]\" value='"+hotelVal+"' size=20>";
...
if($this->row[0]->off_season==1){

$this->row[0]->off_season="淡季";

}else{

$this->row[0]->off_season="旺季";
}
...
?>
			<input type="text" name="off_season[<?php echo $priceid;?>]" id="off_season[<?php echo $priceid;?>]" value="<?php echo $this->row[0]->off_season;?>" size=30>
			</td>
			<td>
			<input type="text" name="two[<?php echo $priceid;?>]" id="two[<?php echo $priceid;?>]" value="<?php echo $this->row[0]->two;?>" size=30>
			</td>

			<td>
			<input type="text" name="three_five[<?php echo $priceid;?>]" id="three_five[<?php echo $priceid;?>]" value="<?php echo $this->row[0]->three_five;?>" size=30>
			</td>
			<td>
			<input type="text" name="six_nice[<?php echo $priceid;?>]" id="six_nice[<?php echo $priceid;?>]" value="<?php echo $this->row[0]->six_nice;?>" size=30>
			</td>
