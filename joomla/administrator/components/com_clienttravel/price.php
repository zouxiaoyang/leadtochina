...
*/
	...
	function remove()
	{
		...
		if($packclass=="small"){
		$this->setRedirect( "index.php?option=com_cntours&view=cntours&c=price&task=editprice&cid[]=$packageid", $msg );}else{
		$this->setRedirect( "index.php?option=com_cntours&view=cntours&c=price&task=editsmprice&cid[]=$packageid", $msg );		
		}
	}
