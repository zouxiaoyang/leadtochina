...
class JAdminSubMenu
{
	...
	function _loadDBList( $componentOption )
	{
		$db   =& JFactory::getDBO();
		$lang =& JFactory::getLanguage();
		if($componentOption=="com_hotelorder" or $componentOption=="com_flicruorder" OR $componentOption=="com_message" OR $componentOption=="com_cusorder"){
			$componentOption="com_order";
		}
