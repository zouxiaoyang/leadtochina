...
/**
* @version 1.5.x
* @package OnlineChinaTours Project
* @email webmaster@onlinechinatours.com
* @copyright (C) 2012 http://www.leadtochina.com. All rights reserved.
*/
...
$cookie_ms = $jvTools->get_cookie('jvmenustyle_jvnews2');
$cookie_layout = $jvTools->get_cookie('layoutstyle_jvnews2');
...
if($get_ms) {
	$menustyle = $get_ms;
	$jvTools->set_cookie('jvmenustyle_jvnews2',$get_ms);
}
if($get_layout) {
	$layoutstyle = $get_layout;
	$jvTools->set_cookie('layoutstyle_jvnews2',$get_layout);
}
/*
 * Behavior 
 */
...
?>
		<img style="cursor: pointer;" id="jvcolor1" src="<?php echo $this->templateurl(); ?>images/color-red.jpg" alt="Red" />
        <img style="cursor: pointer;" id="jvcolor2" src="<?php echo $this->templateurl(); ?>images/color-purple.jpg" alt="Purple" />
  		<img style="cursor: pointer;" id="jvcolor3" src="<?php echo $this->templateurl(); ?>images/color-black.jpg" alt="Black" />
<?php
	}
	function getChangeFont ($jv_tools) {
?>
		<img style="cursor: pointer;" src="<?php echo $this->templateurl(); ?>images/A-minus.jpg" onclick="switchFontSize('<?php echo $this->template."_jv_font";?>','dec'); return false;" alt="" />
		<img style="cursor: pointer;" src="<?php echo $this->templateurl(); ?>images/A-def.jpg" onclick="switchFontSize('<?php echo $this->template."_jv_font";?>',<?php echo $this->_tpl->params->get('jv_font');?>); return false;" alt="" />
		<img style="cursor: pointer;" src="<?php echo $this->templateurl(); ?>images/A-plus.jpg" onclick="switchFontSize('<?php echo $this->template."_jv_font";?>','inc'); return false;" alt="" />
...
<?php
	...
	function parse_jvcolor_cookie() {
		$_tpl_cookie =  $this->get_cookie('JVNews2StyleCookieSite');
