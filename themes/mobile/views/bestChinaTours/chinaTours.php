...
requirements. Remember! We’re the local experts and here to help you.</p>
	...
	<?php /*?><div class="row hidden-xs">
		<div class="col-sm-4 content-collection product-block02">
      	...
      	<div class="col-sm-4 content-collection product-block02">
            <a href="<?php echo Yii::app()->createUrl('bestChinaTours/index',array('name'=>'family-tours'));?>" class="content-collection-inner">
      	...
      	<div class="col-sm-4 content-collection product-block02">
            <a href="<?php echo Yii::app()->createUrl('bestChinaTours/index',array('name'=>'silk-road-tours'));?>" class="content-collection-inner">
...
<div class="chinatour-bottom-banner hidden-xs">
	...
	<div class="text01">
        ...
        <a href="/order/new_order" class="more-link01">Start Now</a>
