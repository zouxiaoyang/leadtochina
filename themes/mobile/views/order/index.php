	...
	<div class="container" >
		...
		<div class="row">
			<div  class="col-md-3 col-xs-12">
				<div class="order-right-view01"> <i class="title01">You are inquiring about this trip</i>
					<div class="content01"> <img src="<?php echo '/'.$ress['filedir'].$ress['pic'];?>" width="262" /> <span><?php echo $ress['name'];?></span>
						...
						<div class="contmod orderinfo">
							...
							<div>
								<table class="table table-bordered">
									<tbody>
										<!--<tr>
											<td class="">Tour Code: &nbsp;  <?php //echo $ress['package_code'];?></td>
										</tr>
									
										<tr>
											<td class="title01">Route:</td>
										</tr>
										<tr>
											<td><?php //echo $ress['route'];?></td>
										</tr>
										<tr class="price">
											<td class="title01">Price Per Person:</td>
										</tr>
										<tr>
											<td><b>From $<?php //echo $ress['price'];?></b></td>
										</tr>-->
									<!--	<tr>
											<td class="title01">Remark</td>
										</tr>
										<tr>
											<td>The price is for reference only, we will work with you to define the final itinerary and offer an accurate price</td>
										</tr>-->
										<tr>
											<td class="on title01"> Your Travel Date:<span class="must">*</span></td>
										</tr>
										<tr>
											<td><input id="entry_date" class="calendarIcon Wdate" type="text" autocomplete="off" name="entry_date"  placeholder="" />
											</td>
										</tr>
										<tr>
											<td class="title01">Approx Duration:<span class="must">*</span></td>
										</tr>
										<tr>
											<td><?php echo $ress['days'];?> <span  style="color:#999;float:right;">Day(s)</span></td>
										</tr>
										<tr>
											<td class="on title01">Hotel Class:<span class="must">*</span></td>
										</tr>
										<tr>
										...
										<tr>
											<td class="on title01">Adults (>11):<span class="must">*</span></td>
										</tr>
										<tr>
											<td><div class="inputmod">
										...
										<tr>
											<td class="on title01">Children (2-11):<span class="must">*</span></td>
										</tr>
										<tr>
											<td><div class="inputmod">
										...
										<tr>
											<td class="on title01">Infants (<2):<span class="must">*</span></td>
										</tr>
										<tr>
											<td><div class="inputmod">
						...
						<div class="contmod contactinfo">
							...
							<div class="">
								<table class="table table-bordered">
									<tbody>
										<tr>
											<td class="on title01">Full Name:<span class="must">*</span></td>
										</tr>
										<tr>
											<td><div class="inputmod">
													<select class="Sex" name="Gender" id="Sex" style="border:1px solid #ccc; background:#eee;">
										...
										<tr>
											<td class="on title01">Nationality:<span class="must">*</span></td>
										</tr>
										<tr>
											<td><div class="inputmod">
										...
										<tr>
											<td class="on title01">Email:<span class="must">*</span></td>
										</tr>
										<tr>
											<td><div class="inputmod">
										...
										<tr>
											<td class="on title01">Alternative Email:</td>
										</tr>
										<tr>
											<td><div class="inputmod">
										...
										<tr>
											<td class="title01">Phone Number:</td>
										</tr>
										<tr>
											<td><div class="inputmod">
										...
										<tr>
											<td class="title01">Promotion Code (optional):</td>
										</tr>
										<tr>
											<td><div class="inputmod">
									...
									<!--	<tr>
											<td class="title01">Your Privacy:</td>
										</tr>
										<tr>
