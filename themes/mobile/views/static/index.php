...
<body>
   <div id="container">
       ...
       <div class="clear"></div>
	   <form method="post" action="<?php echo Yii::app()->createUrl('/unsubscribeEmail/');?>" name="formname">
       <div class="content">
   ...
   <script>
		function check_form()
		{
			$.post("http://www.leadtochina.com/unsubscribeEmail",{email:$('#email').val()}, function(){
				window.opener=null;
				window.open('','_self');
				window.close();
			})
