...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'http_url'); ?>
		<?php echo $form->textField($model,'http_url',array('size'=>60,'maxlength'=>2000)); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'img_video'); ?>
		<?php echo $form->textField($model,'img_video'); ?>
	</div>
