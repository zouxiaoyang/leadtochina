...
class AdoptionPackage extends CActiveRecord
{
	...
	public function getRecommendpackage($id){
		...
		if($package->package_id){
			...
			//$packageInfo=Yii::app()->db->createCommand("select a.*,b.url from jos_cos_tours_package a LEFT JOIN jos_cos_route b ON a.id=b.packageid where a.id=".(int)$package->package_id)->queryAll();
		}
