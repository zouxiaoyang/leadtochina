...
class Cruise extends CActiveRecord
{
  ...
  static $isHideArr = array(
	...
	public function rules()
	{
		...
		return array(
			array('cruise_name, category, up_week,uphighprice,uplowprice, downlowprice, downhighprice, down_week', 'required'),
			array('total_passengers, crew,  passenger_decks, published,  upcity, downcity, category, recommend, month_recommend, index_recommend, up_week, down_week, is_hide', 'numerical', 'integerOnly'=>true),
  ...
  {  	
      ...
      if($_GET['sailling_date']) {
        $date = date("Y-m-d",strtotime($_GET['sailling_date']));
      	$condition[] = "b.cruise_date='$date'";
      }else{
