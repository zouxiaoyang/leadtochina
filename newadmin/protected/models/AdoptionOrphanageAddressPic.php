...
/**
 * This is the model class for table "{{adoption_orphanage_address_pic}}".
 *
 * The followings are the available columns in table '{{adoption_orphanage_address_pic}}':
 * @property integer $id
...
class AdoptionOrphanageAddressPic extends CActiveRecord
{
	...
	{
		return '{{adoption_orphanage_address_pic}}';
	}
