...
//留言弹窗
  ...
  public function actionAjaxAddMessage(){
    ...
    $message = "<b>Message :</b>".mysql_real_escape_string($_POST['message'])."</br>";
	if($_POST['Cruise_Ship']){
    	$message .= "<b>Cruise Ship :</b>".mysql_real_escape_string($_POST['Cruise_Ship'])."</br>";
	}
    if($_POST['Gender']){
    	 $username .= mysql_real_escape_string($_POST['Gender']);
 	}
    $username .= mysql_real_escape_string($_POST['username']);
	if($_POST['Transfer']){
		$message.="<b>Transfer :</b>".mysql_real_escape_string($_POST['Transfer'])."</br>";	
	}
	if($_POST['Travelers']){
		$message.="<b>Number of Travelers :</b>".mysql_real_escape_string($_POST['Travelers'])."</br>";	
	}
	if($_POST['Suitcases']){
		$message.="<b>Number of Suitcases :</b>".mysql_real_escape_string($_POST['Suitcases'])."</br>";	
	}
	if($_POST['telephone']){
		$message.="<b>Number of Suitcases :</b>".mysql_real_escape_string($_POST['telephone'])."</br>";	
	}
