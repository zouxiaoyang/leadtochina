   ...
   <!--  <div id="banner"><img src="/images/cruise/banner1.jpg" alt="" usemap="#Map" /><map name="Map" id="Map"><area shape="rect" coords="488,275,595,301" href="#quick" /></map></div>  --> 
    ...
    <div id="right">        
        ...
        <div class="tourlist2" style="margin-top:20px;" id="tianjin">
           <h2>Tianjin Travel Service for Passengers from Voyager of the Seas</h2>
        ...
        <div class="tourlist2" style="margin-top:20px;" id="shanghai">
           <h2>Shanghai Travel Service for Passengers from Voyager of the Seas</h2>
           <div class="listpic1"><img src="/images/cruise/pic14.jpg" alt="" ></div>
           <div class="listcontent2"><p>Are you looking for a reliable partner to offer you a fast and safe Shanghai cruise terminal transfer service, this is the right place to plan your cruise transfer. Enjoy a privately guided shore excursion to the picturesque towns of Suzhou and Zhouzhuang while in port in Shanghai.</p>
