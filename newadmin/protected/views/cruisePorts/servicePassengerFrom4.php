   ...
   <!--  <div id="banner"><img src="/images/cruise/banner1.jpg" alt="" usemap="#Map" /><map name="Map" id="Map"><area shape="rect" coords="488,275,595,301" href="#quick" /></map></div>  --> 
    ...
    <div id="right">        
        ...
        <div class="tourlist2" style="margin-top:20px;" id="tianjin">
           <h2>Tianjin Travel Service for Passengers from Holland America Volemdam</h2>
           ...
           <div class="listul1">
              ...
              <ul>
                     ...
                     <li>
                      <a href="/travel/china-2-days-tianjin-port--beijing-round-trip--overnight-on-ship--912.html">2 Days Tianjin Port &amp; Beijing Round Trip ( Overnight on Ship ) <span>  from US$230</span></a> 
                     </li> 
                      <p>&nbsp;</p>
                     <li>
        ...
        <div class="tourlist2" style="margin-top:20px;" id="shanghai">
           <h2>Shanghai Travel Service for Passengers from Holland America Volemdam</h2>
           <div class="listpic1"><img src="/images/cruise/pic10.jpg" alt="" ></div>
           <div class="listcontent2"><p>If you take Holland America Volemdam cruise ship to Shanghai, 2 days Shanghai city tours and her side trip to Suzhou, Zhouzhuang Water Town are highly recommended. Meanwhile, we are offering private cruise port transfers with excellent English guide. You also may customize own tour from our help.</p>
