...
<div class="cru_content">
      <div class="cru_menu-tours">
        <strong>You are here:</strong><a href="/">Home</a> <a href="<?php echo Yii::app()->createUrl('cruisePorts/index2');?>">International Cruise</a> <?php echo $cur_cruise->name;?>
      </div>
<div class="clear"></div>
      <div class="">
      <img src="<?php echo ImageUtils::getThumbnail(InternationalCruise::UPLOAD_PATH . $cur_cruise->pic, '920x250');?>" width="920" height="250" />
      </div>
    ...
    <div class="cru_cruise_content_left">
     <ul>
        <?php foreach($cruise_list as $k=>$v):?>
          <li><a href="<?php echo Yii::app()->createUrl("cruisePorts/CruiseView", array("id"=>$v->id,"name"=>SiteUtils::stringURLSafe($v->name)));?>" <?php if($v->id==$_GET['id']):?>class="selected"<?php endif;?>><?php echo $v->name;?><?php if($k==1):?><img src="/images/citytours/hot.gif"><?php endif;?></a></li>
        <?php endforeach;?>
     </ul>
   ...
   <div class="cru_cruise_content_right_intro cru_mt10"> 
      <?php echo $cur_cruise->intro;?>
   </div>
<div class="cru_cruise_content_right_time" >
<table width="100%" border="0" cellpadding="10" cellspacing="1" bgcolor="#cccccc">
<tr>
    <th height="25" colspan="3" align="center" bgcolor="#dddddd" scope="col" style="color:#000; font-size:13px"><b><?php echo $cur_cruise->name;?> Cruise China Schedule  2015/2016</b></th>
    </tr>
  <tr>
    ...
    <?php foreach($cur_cruise_excursions as $k=>$v):?>
       ...
       <p class="cru_view_content_right1_tit2 cru_mt10"><?php echo $v->name;?></p>
           <p class="cru_view_content_right1_tit3 cru_view_mt5">
              <?php echo $v->intro;?>
           </p>
