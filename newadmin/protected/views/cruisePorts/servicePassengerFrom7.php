   ...
   <!--  <div id="banner"><img src="/images/cruise/banner1.jpg" alt="" usemap="#Map" /><map name="Map" id="Map"><area shape="rect" coords="488,275,595,301" href="#quick" /></map></div>  -->  
    ...
    <div id="right">        
        ...
        <div class="tourlist2" style="margin-top:20px;" id="tianjin">
           <h2>Tianjin Travel Service for Passengers from Regent Seven Seas Voyager </h2>
           ...
           <div class="listul1">
             <ul>
                     <li>
                      <a href="/travel/china-2-days-tianjin-port--beijing-round-trip--overnight-in-beijing--923.html">2 Days Tianjin Port &amp; Beijing Round Trip  ( Overnight in Beijing ) <span>  from US$240</span></a> 
                     </li> 
                                     <li>
        ...
        <div class="tourlist2" style="margin-top:20px;" id="shanghai">
           <h2>Shanghai Travel Service for Passengers from Regent Seven Seas Voyager</h2>
           <div class="listpic1"><img src="/images/cruise/pic13.jpg" alt="" ></div>
           <div class="listcontent2"><p>If you take Regent Seven Seas Voyager cruise ship, 1-3 days pre/post-cruise tours to Shanghai or Suzhou Hangzhou tour is a good choice. We are offering private cruise port transfers with English guide service. You may customize own tour from our help.</p>
