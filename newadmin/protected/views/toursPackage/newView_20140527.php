...
<div id="index">
    ...
    <div class="menu-table" id="tab-menu">
       <ul>
          ...
          <li onclick="_tab.change('tab6', this);"><a href="#tips">Tips</a></li>
            ...
            <div class="days">
                ...
                <div class="dayscontent">
                  ...
                  <ul>
                     ...
                     <li class="accommod">Accommodation:
                      <?php //if($v->hotel_grade_str):?>
    ...
    <div class="virtual" id="tab3" style="display:none;">
       ...
       <div class="smallpic" id="thumbs">
          <div class="smallleft"><img class="play_prev" src="/images/view/leftsmall.png" /></div>
          <ul>
    ...
    <div class="tips" id="tab6" style=" display:none;">
  ...
  _tab = {
    change:function(tabid, obj){
      if(tabid == 'tab1' || tabid == 'tab2'){
        $("#tab1,#tab2,#tab3,#tab4,#tab5,#tab6,#similar_tour").hide();
        $("#tab1").show();
        $("#tab2").show();
