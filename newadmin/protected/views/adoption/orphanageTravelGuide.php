...
<div class="content1">
  ...
  <div id="left1" style="margin-top:0px;">
     <!--  overview start  -->
     <div class="overview">
        <!-- <div class="title1"><?php echo $cityinfo->name;?> Overview Orphanage</div> -->
		<div class="title1"><?php echo $orphanage_address_info->orphanage_name;?></div>
        <div class="viewcont">
     ...
     <div class="return">
        ...
        <div class="latest-list">
          ...
          <ul>
          <li class="pic"><a href="<?php echo Yii::app()->createUrl('adoption/orphanageArticle', array('title'=>SiteUtils::stringURLSafe($v->title),'id'=>$v->id));?>"><img src="<?php echo ImageUtils::getThumbnail(AdoptionOrphanageAddressArticle::UPLOAD_PATH.$v->pic, '152x85')?>"  /></a></li>
   ...
   <?php endif;?>
     <!--  return start  -->
      ...
      <!--  photos start  -->
     <div class="photos">
        <div class="title1"><span>Images from <?php echo $cityinfo->name;?> Orphanage</span></div>
     ...
     <!--  return start  -->
     <div class="return">
        <div class="title1">Return-trip Guide Orphanage</div>
        <div class="middle">         
         <div class="onecont">
...
<script src="http://ditu.google.com/maps?file=api&amp;v=2&amp;key=AIzaSyDLv_cEla36IIOJ3nBqa6nzKYEKP5bKmvQ&hl=en&v=2" type="text/javascript"></script>
<script>
