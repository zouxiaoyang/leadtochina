<?php Yii::app()->clientScript->registerCssFile(Yii::app()->request->baseUrl.'/css/adoptionNew.css');?>
<?php Yii::app()->clientScript->registerScriptFile(Yii::app()->request->baseUrl.'/js/My97DatePicker/WdatePicker.js');?>
<?php
 $this->setPageTitle("Customize China Homeland Tours, Tailor-make Your Heritage Tours China");
 Yii::app()->clientScript->registerMetaTag('keywords','china homeland tours, heritage tours china, china adoption tour');
 Yii::app()->clientScript->registerMetaTag('description','Customize China homeland tours including flexible tour schedule, orphanage visiting, English guide, interesting activities to experience China culture.');
?>
<style type="text/css">
  <!--
  #cboxClose{display:none !important;}
  .leftspace{ width:100%; height:auto; float:left;}
  #content{ width:945px; padding: 9px 8px 12px 8px;}
  -->
</style>
<div class="leftspace">
<div>
<div id="content">
  <div id="menu-tours" style="width:935px"><strong>You are here:</strong> <a href="/">Home</a> <a href="<?php echo Yii::app()->createUrl('adoption');?>">China Adoption Tours</a> Customize</div>
<div class="top">
  <div class="img"><img src="/images/adoption/adoption_r1_c1.jpg" width="700" height="167" /></div>
  <div class="top_right">
...
<div class="title">
  <div class="title">
    <div class="Adoption_titledq" id="Adoption_title1" onclick="_adoption.changeTab(1, this);">Customize Adoption Travel</div>
    <!-- <div class="Adoption_title2" id="Adoption_title2" onclick="_adoption.changeTab(2, this);">Provincial Children Reunion Tours</div>  -->
  </div>
</div>
...
<!--  <div class="Adoption_txt" id="adoption_tab_2" style="display:none">
...
<div class="Select_field_box">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <!--  <tr>
        <td align="right"><strong>Activities:</strong></td>
        <td><label for="textfield2"></label>
          <input name="activities" type="text" class="text_field" id="activities" /></td>
      </tr>
      -->
    </table>
</div>
...
<div class="search_results_bok">
  <div class="search_results_right"><strong>Birthplace:</strong><span id="birthplace2" style="margin-left:5px"></span><br />
    ...
    <select name="Duration" class="selec_day">
...
<div class="tour_date_box">
  <div class="tour_date_1">Tour Date</div>
  <div class="tour_date_2">Tour Space</div>
  <div class="tour_date_3">
    <label for="select2"></label>
    <select name="tour_space" class="selec_day">
      <option selected="selected" value="slow">Slow</option>
      <option value="medium">Medium</option>
      <option value="fast">Fast</option>
    </select>
  </div>
  <div class="tour_date_2">Tour For</div>
  <div class="tour_date_4">
    <label for="select2"></label>
    <select name="tour_for" class="selec_day">
