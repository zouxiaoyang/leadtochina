<?php
   ...
   $this->setPageTitle("Best China Tours from South Africa, China Holiday Packages from South Africa 201");
   Yii::app()->clientScript->registerMetaTag('keywords','china tours from south africa, china holiday packages from south africa, travel to china from south africa');
   Yii::app()->clientScript->registerMetaTag('description','4-15 Days China tours packages to Beijing, Xian, Shanghai...with best price. Free to customize china holiday packages from South Africa now.');
 ?>
<style type="text/css">
...
#banner{background:url(/images/citytours/banner_safrica.jpg) left center no-repeat; height:270px; padding-left:670px; width:250px; padding-top:10px;}
...
<!--  index start  -->
<div class="index">
    <div id="menu-tours"><strong>You are here:</strong> <a href="/">Home</a> <a href="<?php echo Yii::app()->createUrl('chinaTours/index');?>">China Tours</a> China Tours From South Africa</div>
    <div id="banner">
    ...
    <div id="left">
        ...
        <div class="toplist">
               ...
               <ul>
                  ...
                  <li>
                      <ol>
                          ...
                          <li>· Summer Palace</li>
                          <li class="price">From <strong>2948 ZAR</strong> P/P</li>
                      </ol>
                  </li>
               </ul>
           </div>
           <div class="listone">
               <ul>
                  ...
                  <li>
                      <ol>
                          <li><a href="/travel/china-8-days-china-golden-standard-tour-17.html">8 Days Best China Tours to Beijing, Xian and Shanghai</a></li>
                          <li>· Forbidden City</li>
                          <li>· Badaling Great Wall</li>
                          <li>· Terracotta Warriors</li>
                          <li>· the Bund</li>
                          <li class="price">From <strong>9600 ZAR</strong> P/P</li>
                      </ol>
                  </li>
               </ul>
           </div>
           <div style="margin-right:0px;" class="listone">
               <ul>
                  <li><a href="/travel/china-10-days-standard-china-essence-tour-22.html"><img alt="" src="/images/citytours/top37.png"></a></li>
                  <li>
                      <ol>
                          <li><a href="/travel/china-10-days-standard-china-essence-tour-22.html">10 Days Classic China Beijing Xian Guilin Yangshuo Tour</a></li>
                          <li>· Great Wall in Beijing</li>
                          <li>· Terracotta Warriors in Xian</li>
                          <li>· Li River Cruise in Guilin</li>
                          <li>· The Bund in Shanghai</li>
                          <li class="price">From <strong>14616 ZAR</strong> P/P</li>
                      </ol>
                  </li>
               </ul>
           </div>
        ...
        <?php 
        	$australia_tours_array = array(
              ...
              'description' => 'As one of the six ancient cities in China, Beijing has been the heart and soul of politics and society throughout its long history, and thus there are unparalleled wealth, with which you can find the splendid past of this city. Besides, Beijing, the capital of the People\'s Republic of China, is the most important transportation hub and port of entry. Most inbound China tours start or end here.',
        		...
        		array(
        			...
        			'tour_ids'  => array(124, 155, 511, 321, 578, 745, 149, 702, 745, 701, 733),
        		),
        		array(
        ...
        <!--  tourlist start  -->
        <div class="tourlist1new">
           <h2><?php echo $v['category1'];?> <span>( <?php echo $v['category2'];?> )</span></h2>
           <div class="listpic1new"><img src="<?php echo $v['image'];?>" alt="" /></div>
           <div class="listcontent1new"><p><?php echo $v['description'];?></p></div>
           <div class="listulnew">
              <ul> 
    ...
    <div class="rightlist">
       ...
       <ul>
          ...
          <li><a href="/travel/yangtzecruise/calendar">2015 Cruise Calendar</a></li>
    ...
    <div class="cooperation"><a href="/travel/cooperation-partner" target="_blank"><img alt="" src="/images/citytours/cooperation1.jpg"></a></div>
   </div>
    <!--  right end  -->
    <div class="clear"></div>
