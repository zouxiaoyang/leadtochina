...
<div class="index">
    ...
    <div class="menu-home">
       <!--  menu-tours start  -->
       <div id="menu-tours"><strong>You are here:</strong> <a href="/">Home</a> <a href="<?php echo Yii::app()->createUrl('promotion');?>">romotion Area</a> Be Face Book Fan</div>
       <!--  menu-tours end  -->
...
<div class="index1">
   ...
   <div id="proright">
      ...
      <div class="rightcont">
         ...
         <div class="protext">
            <div class="propic">
               <img src="/images/promotion/facebook.jpg" alt="" />
               <div class="prodesc"><h2>Be Face Book Fan</h2>
                   <span>Author: Leadtochina</span> <span>Time: 2013-08-20</span> <span>Hits: 1000</span>                      
               </div>
            </div>
            <div class="clear"></div>
            <p>1. Click Like button on our Face book saves $15 USD (only available at the total costs of $600 USD).<br />
               2. Click Like button and be our fan on Facebook, saves $50 USD (only available at Top 10 China tours and Yangtze Cruise Tour).<br />
               3. You cannot enjoy the 1 and 2 at one time. Once you have been our fan, you will enjoy the 1 or 2 all the time.</p>
         </div>
         <!--  protext end  -->
