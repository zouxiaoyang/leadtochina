...
<div class="index">
    ...
    <div class="menu-home">
       <!--  menu-tours start  -->
       <div id="menu-tours"><strong>You are here:</strong> <a href="/">Home</a> <a href="<?php echo Yii::app()->createUrl('promotion');?>">Promotion Area</a> Early Bird Discounts</div>
       <!--  menu-tours end  -->
...
<div class="index1">
   ...
   <div id="proright">
      ...
      <div class="rightcont">
         ...
         <div class="protext">
            <div class="propic">
               <img src="/images/promotion/early.jpg" alt="" />
               <div class="prodesc"><h2>Early Bird Discounts</h2>
                   <span>Author: Leadtochina</span> <span>Hits: 1000</span>                      
               </div>
            </div>
            <div class="clear"></div>
            <p>The date that your 30% deposit arrives at our bank account:<br />
               1. Book Tour 3 Months before the start, a 5% discount will be offered. <br />
               2. Book Tour 2 Months before the start, a 2% discount will be offered.<br />
               3. Not Available if the Tour Quotation less than $500</p>
         </div>
         <!--  protext end  -->
