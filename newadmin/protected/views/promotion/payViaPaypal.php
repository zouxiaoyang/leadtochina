...
<div class="index">
    ...
    <div class="menu-home">
       <!--  menu-tours start  -->
       <div id="menu-tours"><strong>You are here:</strong> <a href="/">Home</a> <a href="<?php echo Yii::app()->createUrl('promotion');?>">Promotion Area</a> Pay Via Paypal</div>
       <!--  menu-tours end  -->
...
<div class="index1">
   ...
   <div id="proright">
      ...
      <div class="rightcont">
         ...
         <div class="protext">
            <div class="propic">
               <img src="/images/promotion/paypal.jpg" alt="" />
               <div class="prodesc"><h2>Pay Via Paypal</h2>
                   <span>Author: Leadtochina</span> <span>Time: 2013-08-20</span> <span>Hits: 1000</span>                      
               </div>
            </div>
            <div class="clear"></div>
            <p>Pay with PayPal, or Credit Card via PayPal<br />
               1. Save $15 USD at every $600 USD.<br />
               2. Book Tour 3 Months before the start, a 5% discount will be offered. <br />
               3. Book Tour 2 Months before the start, a 2% discount will be offered.<br />
               4. Not Available if the Tour Quotation less than $500
            </p>
            <p><strong>Note:</strong> <span style="color:#8c4600">**</span> PayPal is one of the most safe online global payment ways. We prefer it for it really concerns the interests both the buyer and the seller. Check the details at Paypal.com. </p>
         </div>
         <!--  protext end  -->
