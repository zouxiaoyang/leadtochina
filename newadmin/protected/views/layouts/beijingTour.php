...
<head>
  ...
  #cboxClose{display:none !important;}
	...
	.menu ul li:hover ul.lastcity{width:140px;}
	.menu ul li:hover ul.lastcity li{ width:137px; white-space:nowrap;}
	.menu ul li:hover ul.lastcity li a { width:127px;}
	
	.menu ul li:hover ul li{ width:187px; white-space:nowrap;}
	.menu ul li:hover ul li a { width:177px;}
	.menu ul li a,.menu ul li a:visited { padding:0px 35px;}
	...
	.menu ul li:hover ul.special-menu{left:-543px;}
...
<div id="header">
  <div class="head">
        ...
        <div class="menu">
         <ul>
            <?php if(Yii::app()->getController()->action->id == 'list'):?>
             <li><a class="hide" href="/">Home</a></li>
            <?php else:?>
             <li><a class="hide" href="/travel/city-beijing-tours">Beijing Tours</a></li>
            <?php endif;?>
             <li><a class="hide" href="#">Theme Tour</a>
                <ul>
                      <li><a href="/travel/search-beijing-tours?theme=113_72+Hours+Visa+Free+Tour">Free-Visa Tour</a></li>
                      <li><a href="/travel/search-beijing-tours?theme=37_Local+Feature">Local Feature Tour</a></li>
                      <li><a href="/travel/search-beijing-tours?theme=110_Beijing+Musilm+Tour">Muslim Tour</a></li>
                      <li><a href="/travel/search-beijing-tours?theme=63_Season+Tours">Season Tour</a></li>
                      <li><a href="/travel/search-beijing-tours?theme=115_Tianjin+Cruise%26+Beijing">Tianjin Cruise &amp; Beijing</a></li>
                      <li><a href="/travel/search-beijing-tours?theme=12_World+Heritage+">World Heritage Tour</a></li>
                </ul>
             </li>
             ...
             <li class="lastmenu"><a class="hide" href="<?php echo Yii::app()->createUrl('cityTours/index');?>">City Tours</a>
                    <ul class="lastcity">
