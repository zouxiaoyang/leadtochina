...
<div id="menu-guide"><strong>You are here: </strong>
    ...
    <a href="<?php echo Yii::app()->createUrl('chinaGuide/cityInfo', array('cityname'=>strtolower($_GET['cityname'])));?>"><?php echo $_GET['cityname'];?></a>
    <a href="<?php echo Yii::app()->createUrl('chinaGuide/cityAttraction', array('cityname'=>strtolower($_GET['cityname'])));?>"><?php echo $_GET['cityname'];?> Attractions</a>
    <?php echo $scenery->name;?>
</div>
...
<div id="guide">
    ...
    <div id="guide-left">
       <div class="text">
        ...
        <?php if(empty($scenery->notes)==false){?>
         <h2><?php echo $scenery->name;?> Notes</h2>  

        <?php echo $scenery->notes;?>
        <?php }?>
        <?php if(empty($scenery->remark)==false){?>
         <h2><?php echo $scenery->name;?> Remark</h2>
        <?php echo $scenery->remark;?>
        <?php }?>
       </div>
    </div>
    <!--  guide-left end  -->
    ...
    <div id="guide-right">
        <!--  right1 start  -->
        <div class="right1">
          <?php $this->Widget('application.components.widgets.TopCityAttractions', array('cityname'=>'beijing')); ?>
        </div>
        <!--  right1 end  -->
