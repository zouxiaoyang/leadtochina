...
.box-corner-model { height: auto;margin-bottom: 10px;padding-bottom: 1px;width: 240px;}
#CDSWIDSSP{ width:236px;}
#CDSWIDSSP .widSSPData{ border:1px #fff solid}
#CDSWIDSSP .widSSPData .widSSPInformation{padding: 8px 0 10px; text-align:center}
...
#CDSWIDSSP .widSSPData dl {text-align:center;padding: 0 2px;}
#CDSWIDSSP .widSSPData .widSSPLegal {clear: both;color: #a4a4a4;font-size: 11px;margin: 5px 2px 2px;text-align:center;}
-->
</style>
<div id="index">
   <!-- quick start -->
     ...
     <div id="myFocus">
         <div class="pic">
             <ul>
                  ...
                  <li><a href="/travel/things/china-rainbow-mountainszhangye-danxia-landform-geological-park-1641.html"><img src="/images/index/banner10.jpg" thumb="" alt="" text="" /></a></li>
   ...
   <div class="menu-index" id="index_tab">
      <span class="dq">Short Stay Tours</span>
      <span>Shore Excursions</span>   
      <span>China Heritage Tours</span>           
      <span>Beijing Tours</span>            
      <span>Yangtze Cruise</span>
   </div>
   <div id="c01">
      <ul>
         <li><a href="<?php echo Yii::app()->createUrl('beijingXianTours/index');?>"><img src="/images/index/sstimg1.jpg" alt="" /></a></li>
      ...
      <ul>
         <li><a href="<?php echo Yii::app()->createUrl('shanghaiXianTours/index');?>"><img src="/images/index/fpic3.jpg" alt="" /></a></li>
         <li><a href="<?php echo Yii::app()->createUrl('shanghaiXianTours/index');?>">Shanghai Xian Tours</a></li>
      </ul>
      <ul>
         <li><a href="/travel/shanghai-to-huangshan-tours.html"><img src="/images/index/sstimg2.jpg" alt="" /></a></li>
         <li><a href="/travel/shanghai-to-huangshan-tours.html">Shanghai Huangshan</a></li>
      </ul>
      <ul style="margin-right:0px;">
         <li><a href="/travel/city-zhangjiajie-tours"><img src="/images/index/sstimg3.jpg" alt="" /></a></li>
         <li><a href="/travel/city-zhangjiajie-tours">Zhangjiajie Fenghuang</a></li>
      </ul>
   </div>
   <div id="c02" style="display:none;">
      <ul>
         <li><a href="/travel/cruise-port/tianjin-port-port-excursion-5"><img src="/images/index/seimg1.jpg" alt="" /></a></li>
         <li><a href="/travel/cruise-port/tianjin-port-port-excursion-5">Beijing Port Excursion</a></li>
      </ul>
      <ul>
         <li><a href="/travel/cruise-port/tianjin-port-port-excursion-5"><img src="/images/index/fpic5.jpg" alt="" /></a></li>
         <li><a href="/travel/cruise-port/tianjin-port-port-excursion-5">Tianjin Port Excursion</a></li>
      </ul>
      <ul>
         <li><a href="/travel/cruise-port/shanghai-port-port-excursion-6"><img src="/images/index/seimg2.jpg" alt="" /></a></li>
         <li><a href="/travel/cruise-port/shanghai-port-port-excursion-6">Shanghai Port Excursion</a></li>
      </ul>
      <ul>
         <li><a href="/travel/cruise-port/dalian-port-port-excursion-7"><img src="/images/index/seimg3.jpg" alt="" /></a></li>
         <li><a href="/travel/cruise-port/dalian-port-port-excursion-7">Dalian Port Excursion</a></li>
      </ul>
      <ul style="margin-right:0px;">
         <li><a href="/travel/cruise-port/hong-kong-port-port-excursion-13"><img src="/images/index/seimg4.jpg" alt="" /></a></li>
         <li><a href="/travel/cruise-port/hong-kong-port-port-excursion-13">Hong Kong Port Excursion</a></li>
      </ul>
   </div>
      ...
      <div class="toursindex">
         ...
         <div class="types">
           <ul>
              ...
              <?php /*?><li><a href="<?php echo Yii::app()->createUrl('chinaTours/classicTours');?>">Classic China tour</a></li><?php */?>
...
<?php */?>    <li><a href="<?php echo Yii::app()->createUrl('china-student-tours');?>">Student Trips to China</a></li>
              <li><a href="<?php echo Yii::app()->createUrl('china-senior-tours');?>">China Senior Tours</a></li>
           </ul>
         </div>
         <!-- types end -->
      ...
      <div class="ideas">
           ...
           <ul>
              ...
              <li>
                  <a href="/travel/things/china-rainbow-mountainszhangye-danxia-landform-geological-park-1641.html">· Zhangye Rainbow Mountains<img src="/images/citytours/hot.gif" style="padding-left:4px;"></a>
...
2013-04-25<a href="<?php echo Yii::app()->createUrl('reviews/index');?>" style="display:block; text-align:right; color:#000000; text-decoration:none; line-height:24px;">All reviews >></a>             
    ...
    <div class="add-new">
        ...
        <!-- free end -->
        <div class="gifts"><a href="/Emergency-Response.html"><img src="/images/index/gifts1.jpg" alt="" /></a></div>
        <div class="clear"></div>
        <!-- guide start -->
      <div class="guide">
       <p><a href="/china-guide/"><img src="/images/index/chinaguide_img.jpg" alt="" /></a></p>
<!--       <h2></h2>
-->       <ul>
          <li style="display:none"><a href="/travel/hotel"><img src="/images/index/hotel1.png" alt="" /> <span>Hotel</span></a></li>
          <li><a href="/travel/city-guide"><img src="/images/index/guide1.png" alt="" /> <span> City Guide</span></a></li>
   ...
   <!-- code start -->
  <div class="code">
   <div class="box-corner-model" style=" width:240px; border:1px solid #589442; background-color:#FFF ">
    <div id="advisor-pic" style="padding:10px 0 0 35px;">
    <div id="TA_certificateOfExcellence884" class="TA_certificateOfExcellence">
     <ul id="a1L2wAZaQ" class="TA_links xqaTJ7XL">
      <li id="U3HdMswGfO" class="OO7L01e">
       <a target="_blank" href="http://www.tripadvisor.com/Attraction_Review-g297403-d3824010-Reviews-Lead_to_China_Tours_Day_Tour-Hefei_Anhui.html"><img src="http://www.tripadvisor.com/img/cdsi/img2/awards/CoE2015_WidgetAsset-14348-2.png" alt="TripAdvisor" class="widCOEImg" id="CDSWIDCOELOGO"/></a>
     </li>
    </ul>
   </div>
<script src="http://www.jscache.com/wejs?wtype=certificateOfExcellence&amp;uniq=884&amp;locationId=3824010&amp;lang=en_US&amp;year=2015&amp;display_version=2"></script></div>
   <div class="index_class"><script type="text/javascript" src="/travel/js/tripadvisor.js"></script></div>
   </div>
