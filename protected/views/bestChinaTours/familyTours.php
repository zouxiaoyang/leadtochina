  ...
  <div class="row">
    <div class="col-sm-9">
      ...
      <div id="section3">
		...
		?>
          <div class="views-row views-row-1 views-row-odd views-row-first tour-preview tour-preview-family" style="margin:0px 40px 20px 0px;">
            <div class="field-content tour-photo"><a href="<?php echo $href;?>"><img width="395" height="270"  src="<?php echo '/'.$res['filedir'].$res['pic']?>" ></a></div>
	...
	<?php endforeach;?>
      ...
      <div id="section4">
        <div class="row">
          ...
          <div class="col-md-4"  style="margin:0; padding:0;"> <img  src="/images/family-img01.jpg" alt=""  /><br>
            &nbsp;</div>
          <div class="col-md-8" style="padding: 0px 42px 0px 0px;">
      ...
      <div id="section5">
        <div class="row">
          ...
          <div class="col-md-4" style="margin:0; padding:0;"> <img  src="/images/family-img02.jpg" alt=""  /><br>
            &nbsp;</div>
          <div class="col-md-8" style="padding: 0px 42px 0px 0px;">
            <div class="panel-group" id="accordion2">
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h4 class="panel-title" onclick="showH('collapseFour')"> <a data-toggle="collapse" data-parent="#accordion2" 
          href="#collapseFour">1.Will my children like the food?<span class="pull-right"> <i class="fa fa-plus-circle collapseFour" style="display:none;"></i> <i class="fa fa-minus-circle"></i> </span></a> </h4>
              ...
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h4 class="panel-title" onclick="showH('collapseFive')"> <a data-toggle="collapse" data-parent="#accordion2" 
          href="#collapseFive">2.What if my child has a food allergy?<span class="pull-right"> <i class="fa fa-plus-circle collapseFive"></i> <i class="fa fa-minus-circle" style="display:none;"></i> </span></a> </h4>
              ...
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h4 class="panel-title" onclick="showH('collapseSix')"> <a data-toggle="collapse" data-parent="#accordion2" 
          href="#collapseSix"> 3.Is there always a vegetarian option?<span class="pull-right"> <i class="fa fa-plus-circle collapseSix"></i> <i class="fa fa-minus-circle" style="display:none;"></i> </span></a> </h4>
              ...
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h4 class="panel-title" onclick="showH('collapseSeven')"> <a data-toggle="collapse" data-parent="#accordion2" 
      ...
      <div id="section6">
        <div class="row">
          ...
          <div class="col-md-4" style="padding:0; margin:0;"> <img  src="/images/family-img04.jpg" alt=""  /><br>
            &nbsp;</div>
          <div class="col-md-8" style="padding: 0px 42px 0px 0px;">
            <div class="panel-group" id="accordion3">
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h4 class="panel-title" onclick="showH('collapseEight')"> <a data-toggle="collapse" data-parent="#accordion3" 
          href="#collapseEight">1.Where to Stay in China?<span class="pull-right"> <i class="fa fa-plus-circle collapseEight" style="display:none;"></i> <i class="fa fa-minus-circle"></i> </span></a> </h4>
              ...
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h4 class="panel-title" onclick="showH('collapseNine')"> <a data-toggle="collapse" data-parent="#accordion3" 
      ...
      <div id="section7">
        <div class="row" style="padding-bottom:80px;">
          ...
          <div class="col-md-4" style="margin:0; padding:0;"> <img  src="/images/family-img03.jpg" alt=""  /><br>
            &nbsp;</div>
          <div class="col-md-8" style="padding: 0px 42px 0px 0px;">
            <div class="panel-group" id="accordion4">
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h4 class="panel-title" onclick="showH('collapseTen')"> <a data-toggle="collapse" data-parent="#accordion4" 
          href="#collapseTen">1.Should I bring a first aid kit?<span class="pull-right"> <i class="fa fa-plus-circle collapseTen" style="display:none;"></i> <i class="fa fa-minus-circle"></i> </span></a> </h4>
              ...
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h4 class="panel-title" onclick="showH('collapseEleven')"> <a data-toggle="collapse" data-parent="#accordion4" 
          href="#collapseEleven">2.How safe is the transport?<span class="pull-right"> <i class="fa fa-plus-circle collapseEleven"></i> <i class="fa fa-minus-circle" style="display:none;"></i> </span></a> </h4>
              ...
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h4 class="panel-title" onclick="showH('collapseTwelve')"> <a data-toggle="collapse" data-parent="#accordion4" 
          href="#collapseTwelve"> 3.Can we drink the water?<span class="pull-right"> <i class="fa fa-plus-circle collapseTwelve"></i> <i class="fa fa-minus-circle" style="display:none;"></i> </span></a> </h4>
              ...
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h4 class="panel-title" onclick="showH('collapseThirteen')"> <a data-toggle="collapse" data-parent="#accordion4" 
    ...
    <div class="col-sm-3" id="myScrollspy">
      <ul class="nav nav-tabs nav-stacked" id="myNav" data-spy="affix">
