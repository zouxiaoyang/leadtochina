...
<?php $form=$this->beginWidget('CActiveForm', array(
 ...
 <div class="quick">
            <h2><img src="/images/beijing_shanghai/quick.jpg" alt="" /></h2>
            <div class="feedback">
         <table cellspacing="0" cellpadding="0" border="0">
           ...
           <tr>
             <td colspan="2">
              <?php echo $form->textArea($model,'message',array('rows'=>4, 'cols'=>28, 'style'=>"width:96%; border:1px solid #b8b8b8; background:#fff; padding-left:5px; margin-top:3px; height:95px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; line-height:18px;","default"=>"abc")); ?>
           ...
           <tr>
             ...
             <td><input type="image" style="width:81px; border:none;" id="Message_submit" alt="Submit" src="/images/beijing_shanghai/submit.jpg" name=""></td>
           </tr>
         </tbody></table>
     </div>
  </div>
